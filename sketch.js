...
function setup() {
  ...
  bloco1 = new Block(640,175,30,40);
  bloco2 = new Block(670,175,30,40);
  bloco3 = new Block(700,175,30,40);
  bloco4 = new Block(730,175,30,40);
  bloco5 = new Block(760,175,30,40);
  bloco6 = new Block(670,135,30,40);
  bloco7 = new Block(700,135,30,40);
